...
# ─────────────────────────────────────────────────────────────────────────────
# 4.  TRIAL INDEX  (SQLite — tracks which Excel files have been processed)
# ─────────────────────────────────────────────────────────────────────────────
...
def find_new_excel_files() -> list:
    """
    Scan SCRIPT_DIR for Excel files matching CEREBRO_Input*.xlsx.
...
# ─────────────────────────────────────────────────────────────────────────────
# 5.  EXCEL → YAML CONVERTER  (the single source of truth)
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# 6.  CACHE INVALIDATOR  (wipes molecule engine cache for new drug names)
# ─────────────────────────────────────────────────────────────────────────────
